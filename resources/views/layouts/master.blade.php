...
<script src="{{ asset('assets/js/app-logistics-dashboard.js') }}"></script> --}}
    ...
    {{-- <!-- DataTables Buttons ColumnVisibility JS --> --}}
    <script type="text/javascript" src="https://cdn.datatables.net/buttons/2.0.1/js/buttons.colVis.min.js"></script>

    <script src="{{ asset('themes/admin/custom/general.js') }}"></script>
    <script>
        $(document).ready(function() {
            var table = $('#em_data').DataTable();
            table.destroy();
            ...
            $('#em_data').DataTable({
                ...
                lengthMenu: [
                    [10, 25, 50, -1],
                    [10, 25, 50, "All"]
                ], // Define the entries per page options
