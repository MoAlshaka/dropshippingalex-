            ...
            @can('Product Catalog')
                <li class="menu-item">
                    ...
                    <ul class="menu-sub">
                        ...
                        @endcan
                        @can('Affiliate Per Delivered')
                            <li class="menu-item">
                                <a href="{{ route('admin.affiliate.per.delivered') }}" class="menu-link">
                                    <div> {{ __('site.AfillatePerDelivered') }}</div>
                                </a>
                            </li>
                        @endcan
                        @can('Affiliate Per Confirmed')
                            <li class="menu-item">
                                <a href="{{ route('admin.affiliate.per.confirmed') }}" class="menu-link">
