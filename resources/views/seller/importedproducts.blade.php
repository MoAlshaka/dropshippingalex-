...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="flex flex-col gap-6">
            <div
                class="card_bg drop-shadow h-full p-4 rounded-md grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4 justify-items-center h-[400px]">
                        ...
                        <div
                            ...
                            <div class="absolute right-[-20px] top-[-18px] h-16 w-16">
                                <div
                                    ...
                                    @if ($sharedProduct->type == 'confirmed')
                                        confirmed
                                    @else
                                        delivered
                                    @endif
