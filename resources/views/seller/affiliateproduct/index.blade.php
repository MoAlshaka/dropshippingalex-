    ...
    <div class="flex flex-col gap-6">
            ...
            <div
                ...
                <div class="w-[200px] h-[110px] hidden md:block">
                    <img class="w-full h-full object-cover rounded-xl"
                        src="{{asset('assets/svg/icons/undraw_discount_d-4-bd.svg')}}" alt="offer-image" />
                </div>
            </div>
        </div>
        @endisset
            ...
            <div class="accordion mt-3" id="accordionExample">
                <div class="accordion-item">
                    ...
                    <div class="accordion-body">
                        <form id="formAuthentication" class="mb-3 row" action="{{ route('search.affiliate.product') }}"
                            method="post">
                            @csrf
        ...
        <div class="bg-white drop-shadow h-full p-4 rounded-md flex gap-6">
            ...
            <a class="hover:border-b-4 hover:border-purple-700 flex gap-2 items-center justify-center"
                ...
                <img src="{{ asset('assets/countries/flags/' . $country->flag) }}" alt="{{ $country->name }}" width="40"
                    height="40">
        ...
        <div
            ...
            <div class="flex flex-col group rounded-md bg-gray-50 drop-shadow hover:border-2 hover:border-purple-700">
                <div class="relative grow">
                    <div
                        class="absolute w-full h-full bg-black opacity-0 ease-in-out duration-300 group-hover:opacity-40">
                    </div>
                    <img class="w-full h-full object-cover"
                        src="{{ asset('assets/products/affiliateproduct/images/' . $product->image) }}" alt="..."
                ...
                <div class="p-2">
                    ...
                    <div class="d-flex gap-2 my-2" style="grid-row-gap: 0.3rem; grid-column-gap: 0.3rem">
                        ...
                        <span class="rounded-md font-bold text-sm">
                            <img src="{{ asset('assets/countries/flags/' . $country->flag) }}" width="20" height="20">
                        </span>
                        @endforeach
                    </div>
                    <div>
