                    ...
                    <div class="accordion-item">
                        ...
                        <div class=" d-flex align-items-center">
                            ...
                            <div class=" h-full flex flex-fill gap-6">
                                ...
                                <a class="hover:border-b-4 hover:border-purple-700 flex gap-2 items-center justify-center"
                                    href="{{ route('seller.new.affiliate.per.delivered') }}">
                                    <i class="mdi mdi-new-box"></i>
                                    {{ __('site.NewProducts') }}
                                </a>
                                <a class="hover:border-b-4 hover:border-purple-700 flex gap-2 items-center justify-center"
                                    href="{{ route('seller.suggested.affiliate.per.delivered') }}">
            ...
            <div class="bg-white drop-shadow h-full p-4 rounded-md flex gap-6">
                ...
                @isset($countries)
                    @foreach ($countries as $country)
                        <a class="hover:border-b-4 hover:border-purple-700 flex gap-2 items-center justify-center"
                            href="{{ route('seller.affiliate.per.delivered.country.filter', $country->id) }}">
