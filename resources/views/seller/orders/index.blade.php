                    ...
                    <div class="offcanvas-body">
                        <form action="{{ route('seller.orders.filter') }}" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <div class=" mb-4">
                                    <div class="form-floating form-floating-outline">
                                        <select name="shipment_status[]" id="type" class="selectpicker w-100"
                                            data-style="btn-default" multiple data-actions-box="true">
                                ...
                                <div class=" mb-4">
                                    <div class="form-floating form-floating-outline">
                                        <select name="payment_status[]" id="type" class="selectpicker w-100"
                                            data-style="btn-default" multiple data-actions-box="true">
                            ...
                            <a href="{{ route('seller.orders.index') }}" class="btn btn-outline-danger waves-effect">
                                {{ __('site.Back') }}</a>
                        </form>
                    </div>
                </div>
