        ...
        <div class="navbar navbar-expand-lg landing-navbar border-top-0 px-3 px-md-4">
            ...
            <div class="collapse navbar-collapse landing-nav-menu" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav me-auto p-3 p-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link fw-medium" href="{{ route('admin.login') }}" target="_blank">Admin</a>
                    </li>
                </ul>
            </div>
            ...
            <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <!-- navbar button: Start -->
                <li>
                    <a href="{{ route('seller.login') }}" class="btn btn-primary px-2 px-sm-4 px-lg-2 px-xl-4"
        ...
        <section id="landingFeatures" class="section-py landing-features">
            <div class="container">
                ...
                <div class="features-icon-wrapper row gx-0 gy-4 g-sm-5">
                    ...
                    <div class="col-lg-4 col-sm-6 text-center features-icon-box">
                        <div class="features-icon mb-3">
                            <img src="{{ asset('assets/img/front-pages/icons/transition-up.png') }}"
                                alt="transition up" />
                        </div>
                    ...
                    <div class="col-lg-4 col-sm-6 text-center features-icon-box">
                        <div class="features-icon mb-3">
                            <img src="{{ asset('assets/img/front-pages/icons/google-docs.png') }}"
                                alt="google docs" />
                        </div>
            ...
            <div class="container">
                <div class="swiper-logo-carousel py-4 my-lg-2">
                    <div class="swiper" id="swiper-clients-logos">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <img src="{{ asset('assets/img/front-pages/branding/logo-1-light.png') }}"
                    ...
                    <div class="col-xl-4 col-lg-6">
                        <div class="card shadow-none">
                            <div class="card-header border-0">
                                ...
                                <img
                                    src="{{ asset('assets/img/front-pages/icons/smiling-icon.png" alt="smiling icon') }}" />
                            </div>
                            <div class="card-body">
