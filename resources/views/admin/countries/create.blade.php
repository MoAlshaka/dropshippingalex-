        ...
        <div class="row">
            ...
            <div class="col-xxl">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form class="flex flex-col gap-6" action="{{ route('countries.store') }}" method="post"
                            enctype="multipart/form-data">
                            @csrf
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="basic-default-name">
                                    {{ __('site.CountryName') }}</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="basic-default-name" name="name"
                                        placeholder="{{ __('site.CountryName') }}" />
                                </div>
                                @error('name')
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" step="0.01" class="form-control" id="basic-default-company"
                                        name="shipping_cost" placeholder="{{ __('site.ShippingCost') }}" />
                                </div>
                            </div>
                            @error('shipping_cost')
                                <div class="text-danger">{{ $message }}</div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="file" step="0.01" class="form-control" id="basic-default-company"
                                        name="flag" placeholder="{{ __('site.Flag') }}" />
                                </div>
                            </div>
                            @error('flag')
                                <div class="text-danger">{{ $message }}</div>
