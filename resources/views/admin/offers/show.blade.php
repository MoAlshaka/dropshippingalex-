...
{{--        </div>--}}
        ...
        <div class="w-full">
            <div class="p-4 sm:p-6 lg:p-8 rounded-xl overflow-hidden drop-shadow-md">
                <div
                    style="background-image: url({{asset('assets/offers/images/'. $offer->image)}})"
                ...
                >
                    ...
                    >
                        <div
                            class="font-bold text-3xl sm:text-5xl lg:text-6xl sm:max-w-xl max-w-xs capitalize text-white"
                        >
                            {{$offer->title}}
                        </div>
                    </div>
            ...
            <div class="p-4 sm:m-6 lg:m-8 bg-white rounded-xl drop-shadow-md">
